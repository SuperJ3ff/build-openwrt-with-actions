...
echo 'src-git openwrt-bandix https://github.com/timsaya/openwrt-bandix.git;main' >> feeds.conf.default
echo 'src-git luci-app-bandix https://github.com/timsaya/luci-app-bandix.git;main' >> feeds.conf.default
